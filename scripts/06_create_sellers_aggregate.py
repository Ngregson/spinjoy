...
try:
    ...
    df_discogs = pd.read_csv('/Users/nicolaslewagon/spinjoy/discogs_releases_dataset_light.csv')
    
    # Format release_date
    df_discogs.release_date = df_discogs.release_date.astype(str)
    df_discogs.release_date = df_discogs.release_date.str[:-2]
    
    # Merge df_sellers_aggregate with df_discogs. "Inner" makes that newest releases of the sellers are not taken into account.
    ...
    df_sellers_aggregate = df_sellers_aggregate[df_sellers_aggregate['format'] == 'Vinyl']
